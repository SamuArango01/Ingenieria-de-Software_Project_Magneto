        ...
        <div className="mx-auto max-w-2xl lg:max-w-none">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              <button
                key={feature.name}
                className="relative group text-left w-full bg-slate-800/40 rounded-xl p-6 border border-slate-700/30 hover:border-blue-500/20 hover:bg-slate-800/60 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-900"
                type="button"
              >
